...
public class CarPacketListener extends PacketAdapter {
	...
	private double ROTATION_SPEED = 1.5; //TUTAJ MELCIK USTAWIASZ JAK SZYBKO MA SKRECAC!
	...
	public void onPacketReceiving(PacketEvent e) {
		if (e.getPacketType() == PacketType.Play.Client.STEER_VEHICLE
			...
			if(!MelerideCarsAPI.getCarsMap().containsKey(MelerideCarsAPI.getSeatConnect().get(something.getUniqueId()))) return;
